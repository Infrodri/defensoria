...
2. **Instrucciones de Sistema** (`INSTRUCCIONES-AGENTES-v2.md`)
...
- [ ] Agente tiene acceso a `INSTRUCCIONES-AGENTES-v2.md`
...
- [ ] Documentos: ARQUITECTURA-FINAL-COMPLETA.md, INSTRUCCIONES-AGENTES-v2.md
...
- INSTRUCCIONES-AGENTES-v2.md (guía técnica)
...
- `INSTRUCCIONES-AGENTES-v2.md` — Guía técnica detallada
