...
## CONTEXTO
Eres un agente especializado en arreglar herramientas de análisis legal/psicológico/social. El sistema actual falla porque requiere transcripciones de audio que no siempre existen.
...
4. **Reporte breve** de qué cambió exactamente
