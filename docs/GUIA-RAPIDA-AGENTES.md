...
|-----------|--------|----------|
| **ROLES-Y-PERMISOS-RESUMEN.md** | 5 min | Resumen ejecutivo: qué hace cada rol |
| **INSTRUCCIONES-AGENTES-v2.md** | 15 min | Detalles técnicos: endpoints, DTOs, flujos |
| **VERIFICACION-SINCRONIZACION.md** | 10 min | Checklist: cómo validar cambios |
...
| Pregunta | Lee |
|----------|-----|
| ¿Qué rol puede hacer esto? | ROLES-Y-PERMISOS-RESUMEN.md |
| ¿Cómo es el flujo técnico? | INSTRUCCIONES-AGENTES-v2.md |
| ¿Cómo verifico mi cambio? | VERIFICACION-SINCRONIZACION.md |
| ¿Cómo es el sistema? | 01-CONTEXTO-PROYECTO.md |
| ¿Cómo es la BD? | data-model/schema-v0.md |
...
1. **Lee ROLES-Y-PERMISOS-RESUMEN.md** (5 min)
2. **Lee INSTRUCCIONES-AGENTES-v2.md** (15 min)
3. **Mira los 3 documentos principales en el INDEX**
4. **Ejecuta VERIFICACION-SINCRONIZACION.md** si haces cambios

---

**Última actualización**: 2026-08-01  
**Creado por**: Kiro Agente Senior  
**Próxima lectura**: ROLES-Y-PERMISOS-RESUMEN.md
