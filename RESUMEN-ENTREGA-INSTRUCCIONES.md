...
### 3. **INSTRUCCIONES-AGENTES-v2.md** (Referencia Técnica Completa)
...
3. Pregunta específica → INSTRUCCIONES-AGENTES-v2.md
```
...
📄 INSTRUCCIONES-AGENTES-v2.md      ← Técnico detallado (15 min)
...
2. Lee `docs/ROLES-Y-PERMISOS-RESUMEN.md` (5 min)
3. Guarda `docs/INSTRUCCIONES-AGENTES-v2.md` como referencia
4. Usa `docs/VERIFICACION-SINCRONIZACION.md` para cambios futuros

### Para agentes nuevos:
1. Envíales `docs/GUIA-RAPIDA-AGENTES.md`
2. Luego `docs/ROLES-Y-PERMISOS-RESUMEN.md`
3. Si necesitan detalles → `docs/INSTRUCCIONES-AGENTES-v2.md`

### Para cambios futuros:
1. Modifica código (backend + frontend)
2. Ejecuta `docs/VERIFICACION-SINCRONIZACION.md` checklist
3. Commit + push
