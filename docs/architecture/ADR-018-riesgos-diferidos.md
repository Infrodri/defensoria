...
## Consecuencias
- `docs/known-risks.md` es la fuente de verdad de este estado; se actualiza cada vez que un riesgo cambia, no se reescribe este ADR por cada resolución individual.
