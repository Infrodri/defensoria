# 📚 GUÍAS DE USUARIO - HERRAMIENTAS PHASE 2

## 👥 AUDIENCIA

### 🔐 ADMINISTRADOR
- Configurar y probar herramientas
- Subir datos de ejemplo manualmente
- Verificar que todo funciona antes de que los profesionales usen

### 👨‍⚖️ PROFESIONALES (Abogado, Psicólogo, Social)
- Usar herramientas en casos reales
- Subir audios de entrevistas
- Generar análisis para sus informes
...
├── 👨‍⚖️ GUIA-ABOGADO.md (herramientas legales)
...
### Nivel Básico (15 min)
- Subir audio y obtener análisis básico
- Interpretar resultados principales

### Nivel Intermedio (30 min)  
- Usar múltiples herramientas en conjunto
- Personalizar análisis según el caso

### Nivel Avanzado (60 min)
- Combinar herramientas de diferentes disciplinas
- Generar reportes integrales
