...
- Marco normativo de la Ley 548 y Ley 1168/1371 documentado en `docs/legal/marco-normativo.md`.
...
└── docs/
    ...
    ├── data-model/schema-v0.md
    ├── legal/marco-normativo.md
    ├── roadmap/phase-1..5-breakdown.md
