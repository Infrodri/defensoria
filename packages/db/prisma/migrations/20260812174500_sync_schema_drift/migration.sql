-- CreateEnum
CREATE TYPE "RagProcessingStatus" AS ENUM ('PENDING', 'PROCESSING', 'COMPLETED', 'FAILED');

-- CreateEnum
CREATE TYPE "IntakeChannel" AS ENUM ('DIRECTO', 'FISCALIA', 'FELCV', 'FELCC', 'JUZGADO', 'UNIDAD_EDUCATIVA', 'CENTRO_SALUD', 'SEDEGES', 'SLIM', 'OTRA_DEFENSORIA', 'OTRO');

-- CreateEnum
CREATE TYPE "IncidentFrequency" AS ENUM ('PRIMERA_VEZ', 'REINCIDENCIA_NO_DENUNCIADA', 'REINCIDENCIA_DENUNCIADA');
