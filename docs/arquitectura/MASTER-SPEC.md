...
> [ADR-001](arquitectura/ADR/ADR-001-foundation.md), el modelo de datos en
> [Schema v0](modelo-datos/schema-v0.md), y el modelo de seguridad en
> [Access Control](seguridad/access-control.md).
...
> Ver especificación completa de tablas en [Schema v0](modelo-datos/schema-v0.md).
...
>
> - Pantallas y rutas → [Roadmap Phase 1](hoja-de-ruta/phase-1-breakdown.md)
> - Seguridad → [Access Control](seguridad/access-control.md)
> - Stack y decisiones → [ADR-001](arquitectura/ADR/ADR-001-foundation.md)
> - Modelo de datos → [Schema v0](modelo-datos/schema-v0.md)
> - Marco legal → [Marco Normativo](marco-legal/marco-normativo.md)
